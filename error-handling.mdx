...
```json
{
  ...
  "message": "Insufficient credits. Add more at Settings > API."
}
```
...
| 402 | `insufficient_credits` | Out of credits | [Add credits](https://www.ninjachat.ai/settings?tab=api) |
...
| `insufficient_credits` | Balance is $0.00 | [Add credits](https://www.ninjachat.ai/settings?tab=api) |
| `invalid_api_key` | Key revoked or copied incorrectly | Keys start with `nj_sk_`. Create a new one in [Settings](https://www.ninjachat.ai/settings?tab=api) |
