...
description: "Check what a request will cost before you run it. Always free."
---

## Request

```bash
POST https://www.ninjachat.ai/api/v1/estimate
...
async function getModelPricing(models, requestCount) {
  const r = await fetch("https://www.ninjachat.ai/api/v1/estimate", {
    method: "POST",
...
curl -X POST https://www.ninjachat.ai/api/v1/estimate \
