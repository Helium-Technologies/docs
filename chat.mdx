...
<Tip>
**New:** Set `model: "auto"` for smart routing (no more manual model picking), `model: "a>b>c"` for fallback chains, or `budget_cents: 1` for budget-aware routing. [See all power features →](#power-features)
</Tip>
