---
title: "Batch"
description: "Send up to 20 prompts in one API call. They all run in parallel."
---
...
```bash
POST https://www.ninjachat.ai/api/v1/batch
...
r = requests.post("https://www.ninjachat.ai/api/v1/batch",
...
const r = await fetch("https://www.ninjachat.ai/api/v1/batch", {
  method: "POST",
  headers: {
