...
description: "Set up your API key and add it to every request."
---
...
[Developers > API Keys](https://www.ninjachat.ai/developers/keys) → Add credits ($10 min) → Create key
...
- Revoke compromised keys instantly from [Developers > API Keys](https://www.ninjachat.ai/developers/keys)
