...
[Settings > API](https://www.ninjachat.ai/settings?tab=api) → Subscribe ($5/mo) → Add credits → Create key
...
| 403 | `subscription_required` | [Subscribe to API ($5/mo)](https://www.ninjachat.ai/settings?tab=api) |
